...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDnsNsRecordSet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-dns.dataDnsNsRecordSet.DataDnsNsRecordSetConfig",
		reflect.TypeOf((*DataDnsNsRecordSetConfig)(nil)).Elem(),
	)
}
