...
func (j *jsiiProxy_DataDnsMxRecordSetMxList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataDnsMxRecordSetMxList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDnsMxRecordSetMxList {
	_init_.Initialize()
...
func NewDataDnsMxRecordSetMxList_Override(d DataDnsMxRecordSetMxList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDnsMxRecordSetMxList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDnsMxRecordSetMxList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDnsMxRecordSetMxList) Resolve(context cdktf.IResolveContext) interface{} {
