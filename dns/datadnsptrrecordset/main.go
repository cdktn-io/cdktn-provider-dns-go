...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDnsPtrRecordSet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-dns.dataDnsPtrRecordSet.DataDnsPtrRecordSetConfig",
		reflect.TypeOf((*DataDnsPtrRecordSetConfig)(nil)).Elem(),
	)
}
