...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDnsCnameRecordSet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-dns.dataDnsCnameRecordSet.DataDnsCnameRecordSetConfig",
		reflect.TypeOf((*DataDnsCnameRecordSetConfig)(nil)).Elem(),
	)
}
